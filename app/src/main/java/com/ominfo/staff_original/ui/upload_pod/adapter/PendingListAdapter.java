...
public class PendingListAdapter extends RecyclerView.Adapter<PendingListAdapter.ViewHolder> {
    ...
    public PendingListAdapter(Context context, List<FetchPendingPodListResult> listData, ItemClickListener itemClickListener) {
    ...
    public void updateList(List<FetchPendingPodListResult> list){
        mListData = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (mListData != null) {
            try {
                ...
                String pdsNo = mListData.get(position).getPDSNo();
                String vehNo = mListData.get(position).getVehicleNo();
                String driverName = mListData.get(position).getTempoDriver();
    ...
    public interface ItemClickListener {
        void onClick(FetchPendingPodListResult data);
    }
}
