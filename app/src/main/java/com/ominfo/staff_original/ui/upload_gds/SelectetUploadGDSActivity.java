...
public class SelectetUploadGDSActivity extends BaseActivity {
    ...
    private void setToolbar(){
        toolbarTitle.setText("GDS pending POD");
    ...
    private void setLrNumberTab(){
        ...
        firstTab.setText("Pending GDS"); // set the Text for the first Tab
        ...
        Fragment fragment = new PendingGDSFragment();
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        fragment = new PendingGDSFragment();
                        break;
                    case 1:
                        fragment = new PendingGDSForUpload();
                        break;
                    default:
                        fragment = new PendingGDSFragment();
                        break;
