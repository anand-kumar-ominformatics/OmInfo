package com.ominfo.staff_original.ui.loading_list.adapter;
...
public class LoadingImagesAdapter extends RecyclerView.Adapter<LoadingImagesAdapter.ViewHolder> {
    ...
    public LoadingImagesAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public LoadingImagesAdapter(Context context, List<KataChitthiImageModel> listData, ListItemSelectListener itemClickListener) {
