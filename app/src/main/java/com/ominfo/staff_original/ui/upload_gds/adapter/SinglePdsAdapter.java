...
public class SinglePdsAdapter extends RecyclerView.Adapter<SinglePdsAdapter.ViewHolder> {
    ItemClickListener itemClickListener;
    private List<GetGdsGcListForPodResult> mListData;
    private Context mContext;


    public SinglePdsAdapter(Context context, List<GetGdsGcListForPodResult> listData, ItemClickListener itemClickListener) {
    ...
    public void updateList(List<GetGdsGcListForPodResult> list){
        mListData = list;
    ...
    public interface ItemClickListener {
        void onClick(GetGdsGcListForPodResult data);
    }
}
