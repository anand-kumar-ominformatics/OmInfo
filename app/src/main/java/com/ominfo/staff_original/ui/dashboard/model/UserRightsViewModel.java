...
public class UserRightsViewModel extends ViewModel {
    private final CompositeDisposable disposables = new CompositeDisposable();
    private final MutableLiveData<ApiResponse> responseLiveData = new MutableLiveData<>();
    private Service service;


    public UserRightsViewModel(Service service) {
    ...
    public void hitUserRightsApi(String loginRequest) {

        disposables.add(service.executeUserRightsAPI(loginRequest)
