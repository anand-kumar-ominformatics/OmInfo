...
public class GdsGcListForPodViewModel extends ViewModel {
    private final CompositeDisposable disposables = new CompositeDisposable();
    private final MutableLiveData<ApiResponse> responseLiveData = new MutableLiveData<>();
    private Service service;


    public GdsGcListForPodViewModel(Service service) {
    ...
    public void hitPdsListForPodApi(String request) {
        ...
        disposables.add(service.executeGdsListForPodAPI(request)
