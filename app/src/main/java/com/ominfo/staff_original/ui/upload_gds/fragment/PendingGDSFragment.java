package com.ominfo.staff_original.ui.upload_gds.fragment;
        ...
        import com.ominfo.staff_original.ui.upload_gds.adapter.PendingGdsListAdapter;
        import com.ominfo.staff_original.ui.upload_gds.model.FetchGDSPendingListViewModel;
        import com.ominfo.staff_original.ui.upload_gds.model.FetchPendingGdsListResponse;
 ...
 * Use the {@link PendingGDSFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PendingGDSFragment extends BaseFragment implements Filterable {
    ...
    private FetchGDSPendingListViewModel fetchPendingListViewModel;
    ...
    public PendingGDSFragment() {
        // Required empty public constructor
    }

    public static PendingGDSFragment newInstance(String param1, String param2) {
        PendingGDSFragment fragment = new PendingGDSFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pending_gds, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((SelectetUploadGDSActivity) mContext).getDeps().inject(this);
        injectAPI();
        mDb = BaseApplication.getInstance().getAppDatabase();

        String date = AppUtils.getCurrentDateInyyyymmdd();
        this.date = date;
    ...
    private void injectAPI() {
        ...
        fetchPendingListViewModel = ViewModelProviders.of(this, mViewModelFactory).get(FetchGDSPendingListViewModel.class);
        fetchPendingListViewModel.getResponse().observe(getViewLifecycleOwner(), apiResponse -> consumeResponse(apiResponse, DynamicAPIPath.GET_GDS_LIST_FOR_POD));
...
//                fetchPendingPodListRequest.setDate( "2022-06-27" );
                ...
                fetchPendingListViewModel.hitGetGdsListForPodApi(bodyInStringFormat);
    ...
    private void setAdapterForLrImageList() {
        ...
        pendingListAdapter = new PendingGdsListAdapter( mContext , mListData,
                new PendingGdsListAdapter.ItemClickListener() {
                    @Override
                    public void onClick(FetchPendingGdsListResult data) {

                        Intent intent = new Intent(getContext(), SingleGDSDetails.class);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            List<FetchPendingGdsListResult> filteredList = new ArrayList<>();
            ...
            if ( pdsFlag && vehFlag && driverFlag ) {
                ...
                for (FetchPendingGdsListResult item : exampleListFull) {

                    if (item.getDDCNo().toLowerCase().equalsIgnoreCase(pdsp) || (item.getDDCNo() == null ? "PDS No" : item.getDDCNo()).toLowerCase().equalsIgnoreCase(pdsp)) {
...
//                    }
    ...
    private List<FetchPendingGdsListResult> exampleListFull;
            ...
            case SUCCESS:
                ...
                if (!apiResponse.data.isJsonNull()) {
                    ...
                    try {
                        ...
                        if (tag.equalsIgnoreCase(DynamicAPIPath.GET_GDS_LIST_FOR_POD)) {

                            FetchPendingGdsListResponse responseModel = new Gson().fromJson(apiResponse.data.toString(), FetchPendingGdsListResponse.class);
    ...
    private void filterDialog() {
        ...
        mDialog.setContentView(R.layout.dialog_for_filter_gds);
    ...
    PendingGdsListAdapter pendingListAdapter;
