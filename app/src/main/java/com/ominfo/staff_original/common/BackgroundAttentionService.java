package com.ominfo.staff_original.common;
...
public class BackgroundAttentionService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (!stopService) {
                        handler.postDelayed(this, Constants.INTERVAL_ATTENDENCE/*TimeUnit.SECONDS.toMillis(300)*/); //5 min //300
                    }
                }
            }
        };
