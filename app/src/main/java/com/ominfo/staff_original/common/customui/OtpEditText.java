package com.ominfo.staff_original.common.customui;
...
public class OtpEditText extends AppCompatEditText {
    ...
    private float mLineSpacing = 3; //8dp by default, height of the text from our lines
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLinesPaint.setColor(getResources().getColor(R.color.back_text_colour));
...
//    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        getPaint().setColor(getResources().getColor(R.color.back_text_colour));
